...
namespace Couchbase.UnitTests.Search
{
    ...
    public class SearchClientTests
    {
        ...
        public async Task Query_IndexNotFound_Throws_IndexNotFoundException()
        {
            ...
            await Assert.ThrowsAsync<IndexNotFoundException>(async () => await client.QueryAsync(new FtsSearchRequest {Index = indexName}));
        }
        ...
        public async Task Query_200_All_TimedOut_Does_Not_Throw()
        {
            ...
            var response =  await client.QueryAsync(new FtsSearchRequest { Index = indexName });
